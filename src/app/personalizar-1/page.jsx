        ...
        <div className="w-full max-w-[500px] sm:max-w-[600px] md:max-w-[700px] lg:max-w-[800px]">
          ...
          <form className="flex flex-col gap-4">
            <input
              type="text"
              placeholder="Nome"
              className="bg-[#F7F6F3] text-black px-4 py-2 mb-2 rounded w-full"
            />

            <input
              type="date"
              className="bg-[#F7F6F3] text-black px-4 py-2 rounded mb-2 pr-10 w-full appearance-none placeholder-transparent"
            ...
            <input
              ...
              className="bg-[#F7F6F3] text-black mb-2 px-4 py-2 rounded"
            />
