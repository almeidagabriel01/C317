...
export default function NonAlcoholicDrinkSelector({ items = [], selectedDrinks, toggleDrink, onNext, onBack, direction }) {
  const itemVariants = {
    ...
    return (
      ...
      >
        <div className="flex items-center justify-center h-64">
          <div className="text-[#E0CEAA] text-lg">Carregando as opções de bebidas não alcoólicas...</div>
        </div>
      </FormStepLayout>
    );
  }
